...
export const ShareCardTwitterButton = styled((props: ButtonProps) => {
  ...
  const handleClick = useCallback(async () => {
    ...
    try {
      ...
      const url = `https://twitter.com/intent/tweet?original_referer=${window.origin}%2F&ref_src=twsrc%5Etfw%7Ctwcamp%5Ebuttonembed%7Ctwterm%5Er&text=HNY%202023%21%20This%20year%20I%20have%20found%20my%20favorite%20community%20%40${state.favouriteCommunity}%20and%20%40spilnotaxyz%20just%20generated%20my%20NFTing%20card%0ACheck%20it%20out%3A%20&url=spilnota.xyz/card/${result.slug}`
